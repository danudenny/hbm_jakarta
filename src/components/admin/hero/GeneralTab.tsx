    ...
    <div className="space-y-6 py-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          />
          <p className="mt-1 text-xs text-gray-500">The main heading displayed in the hero section</p>
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">
            Section Subtitle
          ...
          <input
            ...
            className="w-full p-2 border border-gray-300 rounded-md"
          />
          <p className="mt-1 text-xs text-gray-500">Optional smaller text displayed above the title</p>
        </div>
      </div>
