...
const ContactSection = () => {
    ...
    const defaultContactData = {
        ...
        content: {
            ...
            contact_info: {
                ...
                email: [
                    'info@visapro-indonesia.com',
                    'support@visapro-indonesia.com',
                ],
                business_hours: [
    ...
    const title = t('title', {
        defaultValue: contactData?.title || defaultContactData.title,
    });
    const subtitle = t('subtitle', {
        defaultValue: contactData?.subtitle || defaultContactData.subtitle,
    });
    const description = t('description', {
        defaultValue:
            contactData?.content?.description ||
            defaultContactData.content.description,
    });

    // Contact info
    const contactInfo =
        contactData?.content?.contact_info ||
        defaultContactData.content.contact_info;
